...
[Solution("Day06", "Part1", "XOR")]
[InputFile("input.txt")]
public class Day06Part1XOR : ISolution
{
    private readonly ILogger<Day06Part1XOR> _logger;
    public Day06Part1XOR(ILogger<Day06Part1XOR> logger) => _logger = logger;
    ...
    public void Run(string inputFile)
    {
        var dataStream = inputFile
            .AsSpan()
            .TrimEnd();
        var toSkip = SkipUniqueSequenceXOR(dataStream, 4);

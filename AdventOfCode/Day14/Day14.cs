...
public abstract class Day14 : ISolution
{
    private readonly bool _includeFloor;
    private readonly ILogger _logger;
    protected Day14(ILogger logger, bool includeFloor)
    {
        _logger = logger;
        _includeFloor = includeFloor;
    }
    ...
    public void Run(string inputFile)
    {
        ...
        // Run simulation until we sand flows into the void
    ...
    private static bool DropSandFrom(ScanData data, Point point)
    {
    ...
    private ScanData ParseInput(SpanLineSplitter input)
    {
        var scanData = new ScanData(_includeFloor);
...
public class ScanData
{
    ...
    public ScanData(bool hasFloor) => _hasFloor = hasFloor;
